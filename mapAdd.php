...
//$mysql->query("INSERT INTO urman3 (number, d, fill) VALUES ('{$_REQUEST['id']}','{$_REQUEST['d']}','{$_REQUEST['fill']}')");

$mysql->query("UPDATE urman23 SET d='{$_REQUEST['d']}' WHERE number='{$_REQUEST['id']}' ");
